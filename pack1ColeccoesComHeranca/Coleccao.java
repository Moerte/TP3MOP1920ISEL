...
public class Coleccao extends Obra {
	...
	public boolean addObra(Obra l1) {
		// TODO
		if (l1 != null && getIndexOfObra(l1.getTitulo()) == -1 /*&& getIndexOfColeccao(l1.getTitulo()) == -1*/) {
	...
	public boolean equals(Object c) {
		...
		return (c != null) && getTitulo().equalsIgnoreCase(((Obra) c).getTitulo())
				&& (test.length == this.editores.length && test.length == c.editores.length);*/
		return (c != null) && this.getTitulo().equalsIgnoreCase(((Obra) c).getTitulo());
